...
//           <h2 className="text-3xl font-extrabold text-gray-900">Featured Startups</h2>
...
//             <div key={startup.name} className="bg-white overflow-hidden shadow-lg rounded-lg">
//               <div className="relative h-48">
//                 <img className="w-full h-full object-cover" src={startup.image} alt={startup.name} />
//               </div>
//               <div className="p-6">
//                 <h3 className="text-xl font-semibold text-gray-900">{startup.name}</h3>
//                 <p className="mt-2 text-gray-500">{startup.description}</p>
                
//                 <div className="mt-4 grid grid-cols-3 gap-4">
//                   <div className="text-center">
//                     <DollarSign className="h-5 w-5 mx-auto text-indigo-600" />
//                     <p className="mt-1 text-sm font-medium text-gray-900">{startup.raised}</p>
//                     <p className="text-xs text-gray-500">Raised</p>
//                   </div>
//                   <div className="text-center">
//                     <Users className="h-5 w-5 mx-auto text-indigo-600" />
//                     <p className="mt-1 text-sm font-medium text-gray-900">{startup.investors}</p>
//                     <p className="text-xs text-gray-500">Investors</p>
//                   </div>
//                   <div className="text-center">
//                     <TrendingUp className="h-5 w-5 mx-auto text-indigo-600" />
//                     <p className="mt-1 text-sm font-medium text-gray-900">{startup.growth}</p>
