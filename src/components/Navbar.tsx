...
//               <span className="ml-2 text-xl font-bold text-gray-900">CrowwdBank</span>
//             </Link>
//           </div>
          
//           <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-8">
//             <Link to="/startups" className="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">
//               Browse Startups
//             </Link>
//             <Link to="/insights" className="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">
//               AI Insights
//             </Link>
...
//             <Link to="/startups" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-indigo-600">
//               Browse Startups
//             </Link>
//             <Link to="/insights" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-indigo-600">
//               AI Insights
//             </Link>
//             <button className="block w-full text-left px-3 py-2 text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
//               Sign In
//             </button>
//           </div>
//         </div>
